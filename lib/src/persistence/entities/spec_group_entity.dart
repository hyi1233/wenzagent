...
class SpecGroupEntity {
  ...
  /// 从 Map 创建
  factory SpecGroupEntity.fromMap(Map<String, dynamic> map) {
  ...
  @override
  String toString() {
    return 'SpecGroupEntity(id: $id, name: $name, employeeId: $employeeId)';
  }
}
